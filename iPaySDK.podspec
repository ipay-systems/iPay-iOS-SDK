#
#  Be sure to run `pod spec lint iPaySDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/iPaySDK"
  ...
  s.source       = { :git => "https://github.com/shovon0203/iPaySDK.git", :tag => "#{s.version}" }
